...
dizionario_da_indice_classe_a_estremo_sinistro_j_1_NEG = {0:270, 1:90, 2:36, 3:72, 4:36, 5:90, 6:108, 7:126, 8:144, 9:162, 10:108,
                                                    11:342, 12:54, 13:18, 14:252, 15:324, 16:306, 17:306, 18:288, 19:342}

dizionario_da_indice_classe_a_estremo_destro_j_1_NEG = {0:288, 1:108, 2:54, 3:90, 4:54, 5:108, 6:126, 7:144, 8:162, 9:180, 10:126,
                                                    11:360, 12:72, 13:36, 14:270, 15:342, 16:324, 17:324, 18:306, 19:360}

#NEG della classe 0 -> classe 15
#NEG della classe 1 -> classe 5
#NEG della classe 2 -> (come prima)
#NEG della classe 3 -> classe 4
#NEG della classe 4 -> classe 2
#NEG della classe 5 -> (come prima)
#NEG della classe 6 -> classe 4 e classe 13
#NEG della classe 7 -> (come prima)
#NEG della classe 8 -> (come prima)
#NEG della classe 9 -> (come prima)
#NEG della classe 10 -> classe 6
#NEG della classe 11 -> classe 19
#NEG della classe 12 -> classe 3
#NEG della classe 13 -> classe 1
#NEG della classe 14 -> (come prima)
#NEG della classe 15 -> classe 18
#NEG della classe 16 -> classe 17
#NEG della classe 17 -> (come prima)
#NEG della classe 18 -> classe 16
#NEG della classe 19 -> (come prima)
...
for i in range(0, 20): #i = indice che scorre tutte le classi (che sono 20 in totale) (mi permette di considerare ogni centroide ci).
    for k in range (0, 16648): #colonna max = 16647; #k = indice che scorre tutte le feature per ogni centroide di ogni classe i-esima.
        ...
        estremo_sinistro_j_1_NEG = dizionario_da_indice_classe_a_estremo_sinistro_j_1_NEG[i]
        estremo_destro_j_1_NEG = dizionario_da_indice_classe_a_estremo_destro_j_1_NEG[i]
        ...
        if((i==0) or (i==1) or (i==3) or (i==4) or (i==10) or (i==11) or (i==12) or (i==13) or (i==15) or (i==16) or (i==18)):
            ...
            for j_2 in range(0, 360):  # non classe alt_atheism #questo j = j_2
                if ((j_2 >= estremo_sinistro_j_1_NEG) and (j_2 < estremo_destro_j_1_NEG)):
                    #per classe 0: (j_2 >= 270) and (j_2 < 288)
                    #per classe 1: (j_2 >= 90) and (j_2 < 108)
                    # e così via..
                    documento_corrente = df_train.iloc[j_2]
                    w_k_j = df_train.iloc[j_2, k]
                    valore_interno_sommatoria = w_k_j / 18  #in questo caso NEG_i=18 perchè qui come esempi negativi sto considerando solamente tutti gli esempi di training che appartengono
                    #alla classe con la quale il classificatore si confonde di più per la classe corrente.
            ...
            sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i = 0
            for j_2 in range(0, 360):  # non classe alt_atheism #questo j = j_2
                if( (j_2 >= dizionario_da_indice_classe_a_estremo_sinistro_j_1[4]) and (j_2 < dizionario_da_indice_classe_a_estremo_sinistro_j_1[4]) or
                    (j_2 >= dizionario_da_indice_classe_a_estremo_sinistro_j_1[13]) and (j_2 < dizionario_da_indice_classe_a_estremo_sinistro_j_1[13]) ):
                    # per i == 0 (prima classe di documenti): (j_2 < 0) or (j_2 >= 18)
                    # per i == 1: (j_2 < 18) or (j_2 >= 36)
                    # e così via..
                    documento_corrente = df_train.iloc[j_2]
                    w_k_j = df_train.iloc[j_2, k]
                    valore_interno_sommatoria = w_k_j / (18*2) #in questo caso NEG_i=18*2 perchè ci sono due classi considerate come negativi (la classe 4 e la 13).
                    sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i = sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i + valore_interno_sommatoria
                    # print("documento_corrente NON classe alt_atheism:")
                    # print(documento_corrente)


        else: #per queste classi come NEG considero tutti gli altri documenti che non appartengono a quella classe come facevo prima.
            sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i = 0
            for j_2 in range(0, 360):
                if ((j_2 < estremo_sinistro_j_1) or (j_2 >= estremo_destro_j_1)):
                    ...
                    documento_corrente = df_train.iloc[j_2]
                    w_k_j = df_train.iloc[j_2, k]
                    valore_interno_sommatoria = w_k_j / NEG_i #in questo caso NEG_i = 18*19 perchè in questo caso considero NEGs standard.
                    sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i = sommatoria_su_tutti_i_documenti_che_non_appartengono_alla_classe_i + valore_interno_sommatoria
                    # print("documento_corrente NON classe alt_atheism:")
                    # print(documento_corrente)
...
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_alt_atheism.txt', 'w') as f:
    str = json.dumps(c_alt_atheism)
    f.write(str)
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_comp_graphics.txt', 'w') as f:
    str = json.dumps(c_comp_graphics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_comp_os_ms_windows_misc.txt', 'w') as f:
    str = json.dumps(c_comp_os_ms_windows_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_comp_sys_ibm_pc_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_ibm_pc_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_comp_sys_mac_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_mac_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_comp_windows_x.txt', 'w') as f:
    str = json.dumps(c_comp_windows_x)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_misc_forsale.txt', 'w') as f:
    str = json.dumps(c_misc_forsale)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_rec_autos.txt', 'w') as f:
    str = json.dumps(c_rec_autos)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_rec_motorcycles.txt', 'w') as f:
    str = json.dumps(c_rec_motorcycles)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_rec_sport_baseball.txt', 'w') as f:
    str = json.dumps(c_rec_sport_baseball)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_rec_sport_hockey.txt', 'w') as f:
    str = json.dumps(c_rec_sport_hockey)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_sci_crypt.txt', 'w') as f:
    str = json.dumps(c_sci_crypt)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_sci_electronics.txt', 'w') as f:
    str = json.dumps(c_sci_electronics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_sci_med.txt', 'w') as f:
    str = json.dumps(c_sci_med)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_sci_space.txt', 'w') as f:
    str = json.dumps(c_sci_space)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_soc_religion_christian.txt', 'w') as f:
    str = json.dumps(c_soc_religion_christian)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_talk_politics_guns.txt', 'w') as f:
    str = json.dumps(c_talk_politics_guns)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_talk_politics_mideast.txt', 'w') as f:
    str = json.dumps(c_talk_politics_mideast)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_talk_politics_misc.txt', 'w') as f:
    str = json.dumps(c_talk_politics_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG raffinata\\c_talk_religion_misc.txt', 'w') as f:
