...
#In questo caso le due liste di documenti di training e test sono state create tenendo conto come contesto di ogni lemma TUTTO il documento stesso in
#cui quel determinato lemma si trova.
...
def classe_piu_vicina(indice_documento_input, dizionario_da_indice_classe_a_estremo_sinistro_j_1, dizionario_da_indice_classe_a_estremo_destro_j_1):
    ...
    for i in range(0, 19):
        ...
        if(i != indice_documento_input):
            ...
            #in lista_documenti_classe_corrente_diversa_da_quella_di_input inserisco tutti e solo i documenti appartenenti alla classe i-esima corrente.
...
for i in range(0, 20): #i = indice che scorre tutte le classi (che sono 20 in totale) (mi permette di considerare ogni centroide ci).
    ...
    for k in range (0, df_train.shape[1]): #colonna max = 16647; #k = indice che scorre tutte le feature per ogni centroide di ogni classe i-esima.
...
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_alt_atheism.txt', 'w') as f:
    str = json.dumps(c_alt_atheism)
    f.write(str)
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_comp_graphics.txt', 'w') as f:
    str = json.dumps(c_comp_graphics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_comp_os_ms_windows_misc.txt', 'w') as f:
    str = json.dumps(c_comp_os_ms_windows_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_comp_sys_ibm_pc_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_ibm_pc_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_comp_sys_mac_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_mac_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_comp_windows_x.txt', 'w') as f:
    str = json.dumps(c_comp_windows_x)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_misc_forsale.txt', 'w') as f:
    str = json.dumps(c_misc_forsale)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_rec_autos.txt', 'w') as f:
    str = json.dumps(c_rec_autos)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_rec_motorcycles.txt', 'w') as f:
    str = json.dumps(c_rec_motorcycles)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_rec_sport_baseball.txt', 'w') as f:
    str = json.dumps(c_rec_sport_baseball)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_rec_sport_hockey.txt', 'w') as f:
    str = json.dumps(c_rec_sport_hockey)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_sci_crypt.txt', 'w') as f:
    str = json.dumps(c_sci_crypt)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_sci_electronics.txt', 'w') as f:
    str = json.dumps(c_sci_electronics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_sci_med.txt', 'w') as f:
    str = json.dumps(c_sci_med)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_sci_space.txt', 'w') as f:
    str = json.dumps(c_sci_space)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_soc_religion_christian.txt', 'w') as f:
    str = json.dumps(c_soc_religion_christian)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_talk_politics_guns.txt', 'w') as f:
    str = json.dumps(c_talk_politics_guns)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_talk_politics_mideast.txt', 'w') as f:
    str = json.dumps(c_talk_politics_mideast)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_talk_politics_misc.txt', 'w') as f:
    str = json.dumps(c_talk_politics_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)-fit_trasform_migliore- i synsets di WN\\c_talk_religion_misc.txt', 'w') as f:
