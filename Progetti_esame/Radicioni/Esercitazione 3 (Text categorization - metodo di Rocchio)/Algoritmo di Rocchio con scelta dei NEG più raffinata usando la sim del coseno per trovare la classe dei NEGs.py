...
#A questo punto devo calcolare il peso associato ad ogni termine presente sia in lista_di_tutti_i_documenti_di_TRAINING_in_inglese.
...
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_alt_atheism.txt', 'w') as f:
    str = json.dumps(c_alt_atheism)
    f.write(str)
with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_comp_graphics.txt', 'w') as f:
    str = json.dumps(c_comp_graphics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_comp_os_ms_windows_misc.txt', 'w') as f:
    str = json.dumps(c_comp_os_ms_windows_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_comp_sys_ibm_pc_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_ibm_pc_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_comp_sys_mac_hardware.txt', 'w') as f:
    str = json.dumps(c_comp_sys_mac_hardware)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_comp_windows_x.txt', 'w') as f:
    str = json.dumps(c_comp_windows_x)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_misc_forsale.txt', 'w') as f:
    str = json.dumps(c_misc_forsale)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_rec_autos.txt', 'w') as f:
    str = json.dumps(c_rec_autos)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_rec_motorcycles.txt', 'w') as f:
    str = json.dumps(c_rec_motorcycles)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_rec_sport_baseball.txt', 'w') as f:
    str = json.dumps(c_rec_sport_baseball)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_rec_sport_hockey.txt', 'w') as f:
    str = json.dumps(c_rec_sport_hockey)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_sci_crypt.txt', 'w') as f:
    str = json.dumps(c_sci_crypt)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_sci_electronics.txt', 'w') as f:
    str = json.dumps(c_sci_electronics)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_sci_med.txt', 'w') as f:
    str = json.dumps(c_sci_med)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_sci_space.txt', 'w') as f:
    str = json.dumps(c_sci_space)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_soc_religion_christian.txt', 'w') as f:
    str = json.dumps(c_soc_religion_christian)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_talk_politics_guns.txt', 'w') as f:
    str = json.dumps(c_talk_politics_guns)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_talk_politics_mideast.txt', 'w') as f:
    str = json.dumps(c_talk_politics_mideast)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_talk_politics_misc.txt', 'w') as f:
    str = json.dumps(c_talk_politics_misc)
    f.write(str)

with open('C:\\Users\\miky9\\PycharmProjects\\pythonProject\\Progetti TLN\\Radicioni\\Esercitazione 3\\Centroidi di Rocchio con scelta dei NEG più raffinata (2)\\c_talk_religion_misc.txt', 'w') as f:
