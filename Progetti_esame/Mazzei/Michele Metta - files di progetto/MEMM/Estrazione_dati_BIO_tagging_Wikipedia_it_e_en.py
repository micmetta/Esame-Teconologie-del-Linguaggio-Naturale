...
def caricamento_dati_BIO_tagging_it ():
    #leggo le frasi dal training set:
    file_train = open("datasets_it/train.conllu", "r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_train.readline()
    while line != "":
...
def frasi_test_set_en(): #con tags
    file_test = open("datasets_en/test.conllu", "r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
...
def frasi_test_set_it(): #con tags
    file_test = open("datasets_it/test.conllu", "r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_test.readline()
    while line != "":
...
def frasi_validation_set_en_con_tags():
    file_test = open("datasets_en/val.conllu","r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_test.readline()
    while line != "":
...
def frasi_validation_set_it_con_tags():
    file_test = open("datasets_it/val.conllu","r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_test.readline()
    while line != "":
...
def frasi_test_fuori_dominio_it(): #con tags
    file_test = open("frasi_fuori_dominio_it.conllu", "r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_test.readline()
    while line != "":
...
def frasi_test_fuori_dominio_en(): #con tags
    file_test = open("frasi_fuori_dominio_en.conllu", "r", encoding="utf8")
    frasi_corpus = []
    frase_corrente = ""
    line = file_test.readline()
    while line != "":
