...
def load_data_test_set():
    ...
    frasi_test_con_tag = Estrazione_dati_BIO_tagging_Wikipedia_it.frasi_test_fuori_dominio_it() #prendo tutte le frasi di test con i rispettivi tags assegnati ad ogni parola.
...
def test(log_reg, data):
    ...
    print("")
    frasi_test_set = Estrazione_dati_BIO_tagging_Wikipedia_it_e_en.frasi_test_fuori_dominio_it() #estraggo tutte le frasi fuori dominio presenti con la funzione che ho creato.
