...
Estrazione_dati_BIO_tagging_Wikipedia_it = importlib.import_module("Estrazione_dati_BIO_tagging_Wikipedia_it_e_en")
...
def calcolo_prob_di_emissione(parola,frasi_corpus,dizionario_count_tags):
    ...
    # QUI FACCIO LO SMOOTHING:#### (PER TESTARE IL COMPORTAMENTO DELL'HMM SULLE DIVERSE FRASI FUORI DOMINIO BISOGNA SELEZIONARE LA
    # TECNICA DI SMOOTHING CHE SI DESIDERA CONSIDERARE QUI SOTTO).
    if (parola_di_input_presente_nel_training_set == False):
        ...
        b_s_o_t = tecniche_smoothing.statistica_development_set()
...
frasi_test_fuori_dominio = Estrazione_dati_BIO_tagging_Wikipedia_it.frasi_test_fuori_dominio_it()
frasi_train, tag_possibili, dizionario_indice_numerico_tag, dizionario_per_passare_dal_tag_al_numero, a_s_primo_s = Estrazione_dati_BIO_tagging_Wikipedia_it.caricamento_dati_BIO_tagging_it()
dizionario_count_tags = Estrazione_dati_BIO_tagging_Wikipedia_it.calcolo_C_s(frasi_train) #Questa funzione mi permette di poter calcolare per ogni possible tag il Count(tag) ovvero il numero di volte in cui un certo tag è
#stato assegnato ad una parola del training set.

print("")
print("frasi_test_fuori_dominio: ")
print(frasi_test_fuori_dominio)
print("")
...
for frase_test in frasi_test_fuori_dominio:
...
accuratezza_modello = Calcolo_metriche.accuratezza(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test)
print("accuratezza_modello: ", accuratezza_modello)


print("")
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("precisione_modello PER: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("precisione_modello LOC: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("precisione_modello ORG: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("precisione_modello MISC: ", precision_modello)

print("")
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("recall_modello PER: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("recall_modello LOC: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("recall_modello ORG: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("recall_modello MISC: ", recall_modello)
print("")


print("")
acc_modello_B_I_PER = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("acc_modello_B_I_PER: ", acc_modello_B_I_PER)
acc_modello_B_I_LOC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("acc_modello_B_I_LOC: ", acc_modello_B_I_LOC)
acc_modello_B_I_ORG = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("acc_modello_B_I_ORG: ", acc_modello_B_I_ORG)
acc_modello_B_I_MISC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("acc_modello_B_I_MISC: ", acc_modello_B_I_MISC)
print("")


print("")
acc_modello_B_I_consecutivi_PER = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("acc_modello_B_I_consecutivi_PER: ", acc_modello_B_I_consecutivi_PER)
acc_modello_B_I_consecutivi_LOC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("acc_modello_B_I_consecutivi_LOC: ", acc_modello_B_I_consecutivi_LOC)
acc_modello_B_I_consecutivi_ORG = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("acc_modello_B_I_consecutivi_ORG: ", acc_modello_B_I_consecutivi_ORG)
acc_modello_B_I_consecutivi_MISC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
