...
frasi_training_set_it_senza_tag = Estrazione_dati_BIO_tagging_Wikipedia_it_e_en.frasi_training_set_it_senza_tag()
frasi_training_set_it_con_tag = Estrazione_dati_BIO_tagging_Wikipedia_it_e_en.frasi_training_set_it_con_tag()
frasi_test_fuori_dominio_it = Estrazione_dati_BIO_tagging_Wikipedia_it_e_en.frasi_test_fuori_dominio_it()


def parola_presente_nel_training_set(parola):
    frasi_corpus = frasi_training_set_it_senza_tag
    #print(frasi_corpus)
...
def tag_piu_frequente(parola):
    frasi_corpus = frasi_training_set_it_con_tag
...
with open('dizionario_con_tag_piu_frequente_di_parole_gia_considerate.json', 'r') as json_file:
    dizionario_con_tag_piu_frequente_di_parole_gia_considerate = json.load(json_file)
#####################################################################################################


######################################################################################################
for frase_test in frasi_test_fuori_dominio_it:
    ...
    for i in range(0, len(frase_test_splittata_per_singola_parola)): #scorro tutte le parole della frase di test corrente
        ...
        if ((parola_frase_test in dizionario_con_tag_piu_frequente_di_parole_gia_considerate) == False):
            ...
            if(parola_presente_nel_training_set(parola_frase_test)):
                ...
                tags_assegnati_frase_di_test_corrente.append("O")
                #memorizzo il tag più frequente nel dizionario (ottimizzazione):
                dizionario_con_tag_piu_frequente_di_parole_gia_considerate[parola_frase_test] = "O"
                print("tag_max assegnato: "+"O")
...
accuratezza_baseline = Calcolo_metriche.accuratezza(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test)
print("accuratezza_baseline: ", accuratezza_baseline)
print("")
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("precisione_modello PER: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("precisione_modello LOC: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("precisione_modello ORG: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("precisione_modello MISC: ", precision_modello)


print("")
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("recall_modello PER: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("recall_modello LOC: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("recall_modello ORG: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("recall_modello MISC: ", recall_modello)
print("")


print("")
acc_modello_B_I_PER = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("acc_modello_B_I_PER: ", acc_modello_B_I_PER)
acc_modello_B_I_LOC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("acc_modello_B_I_LOC: ", acc_modello_B_I_LOC)
acc_modello_B_I_ORG = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("acc_modello_B_I_ORG: ", acc_modello_B_I_ORG)
acc_modello_B_I_MISC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("acc_modello_B_I_MISC: ", acc_modello_B_I_MISC)
print("")

print("")
acc_modello_B_I_consecutivi_PER = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("acc_modello_B_I_consecutivi_PER: ", acc_modello_B_I_consecutivi_PER)
acc_modello_B_I_consecutivi_LOC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("acc_modello_B_I_consecutivi_LOC: ", acc_modello_B_I_consecutivi_LOC)
acc_modello_B_I_consecutivi_ORG = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("acc_modello_B_I_consecutivi_ORG: ", acc_modello_B_I_consecutivi_ORG)
acc_modello_B_I_consecutivi_MISC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_fuori_dominio_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
