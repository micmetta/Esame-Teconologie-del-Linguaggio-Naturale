...
# Loading it from file
with open(
        'dizionario_con_prob_di_emissione_di_parole_gia_considerate_tecnica_STESSA_DISTRIBUZIONE_SU_TUTTI_I_TAGS.json', 'r') as json_file:
    dizionario_con_prob_di_emissione_di_parole_gia_considerate = json.load(json_file)
############################################################################
...
# with open("dizionario_con_prob_di_emissione_di_parole_gia_considerate_tecnica_STESSA_DISTRIBUZIONE_SU_TUTTI_I_TAGS.json", 'w') as json_file:
