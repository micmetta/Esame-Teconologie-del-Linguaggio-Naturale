...
frasi_test_set_it = Estrazione_dati_BIO_tagging_Wikipedia_it_e_en.frasi_test_set_it()
...
######################################################################################################
for frase_test in frasi_test_set_it:
...
# Dumping it to file
# with open('dizionario_con_tag_piu_frequente_di_parole_gia_considerate.json', 'w', encoding="utf8") as json_file:
...
accuratezza_baseline = Calcolo_metriche.accuratezza(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test)
print("accuratezza_baseline: ", accuratezza_baseline)

print("")
precision_modello = Calcolo_metriche.precision(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("precisione_modello PER: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("precisione_modello LOC: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("precisione_modello ORG: ", precision_modello)
precision_modello = Calcolo_metriche.precision(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("precisione_modello MISC: ", precision_modello)


print("")
recall_modello = Calcolo_metriche.recall(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("recall_modello PER: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("recall_modello LOC: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("recall_modello ORG: ", recall_modello)
recall_modello = Calcolo_metriche.recall(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("recall_modello MISC: ", recall_modello)
print("")


print("")
acc_modello_B_I_PER = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
print("acc_modello_B_I_PER: ", acc_modello_B_I_PER)
acc_modello_B_I_LOC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
print("acc_modello_B_I_LOC: ", acc_modello_B_I_LOC)
acc_modello_B_I_ORG = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
print("acc_modello_B_I_ORG: ", acc_modello_B_I_ORG)
acc_modello_B_I_MISC = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
print("acc_modello_B_I_MISC: ", acc_modello_B_I_MISC)
acc_modello_O = Calcolo_metriche.accuratezza_B_I_entity(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "O")
...
# print("")
# acc_modello_B_I_consecutivi_PER = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "PER")
# print("acc_modello_B_I_consecutivi_PER: ", acc_modello_B_I_consecutivi_PER)
# acc_modello_B_I_consecutivi_LOC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "LOC")
# print("acc_modello_B_I_consecutivi_LOC: ", acc_modello_B_I_consecutivi_LOC)
# acc_modello_B_I_consecutivi_ORG = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "ORG")
# print("acc_modello_B_I_consecutivi_ORG: ", acc_modello_B_I_consecutivi_ORG)
# acc_modello_B_I_consecutivi_MISC = Calcolo_metriche.accuratezza_B_I_consecutivi(frasi_test_set_it, tags_assegnati_a_tutte_le_frasi_di_test, "MISC")
