...
with open('dizionario_con_tag_piu_frequente_di_parole_gia_considerate_baseline_B-MISC.json', 'r') as json_file:
...
# Dumping it to file
# with open('dizionario_con_tag_piu_frequente_di_parole_gia_considerate_baseline_B-MISC.json', 'w', encoding="utf8") as json_file:
