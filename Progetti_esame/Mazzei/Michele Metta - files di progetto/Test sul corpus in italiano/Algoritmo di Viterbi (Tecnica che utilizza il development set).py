...
with open('dizionario_con_prob_di_emissione_di_parole_gia_considerate_tecnica_statistica_sul_DEVELOPMENT_SET.json', 'r') as json_file:
    dizionario_con_prob_di_emissione_di_parole_gia_considerate = json.load(json_file)
...
frasi_test_set = Estrazione_dati_BIO_tagging_Wikipedia_it.frasi_test_set_it()
...
# with open("dizionario_con_prob_di_emissione_di_parole_gia_considerate_tecnica_statistica_sul_DEVELOPMENT_SET.json", 'w') as json_file:
...
accuratezza_modello = Calcolo_metriche.accuratezza(frasi_test_set, tags_assegnati_a_tutte_le_frasi_di_test)
